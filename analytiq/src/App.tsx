...
export default function App() {
  ...
  const simulatedCashFlow = Math.round(baseCashFlow + (simulatedProfit - latestProfit) * 0.85 - (hiringAdj > 0 ? hiringAdj * 2500 : 0));
  const simulatedRetention = Math.min(100, Math.max(30, 92 - (priceAdj * 0.7) + (marketingAdj * 0.09)));
